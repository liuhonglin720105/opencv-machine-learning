...
class Board():
    ...
    def place_stone(self, player, point):
        ...
        self._hash ^= zobrist.HASH_COED[point, player]
        for other_color_string in adjacent_opposite_color: #相邻异色棋块去掉一气
            replacement = other_color_string.without_liberty(point)
            if replacement.num_liberties:
                self.replace_string(other_color_string.without_liberty(point))
            else:
                self._remove_string(other_color_string)
       
    def _replace_strintg(self, new_string):
    ...
    def _remove_string(self, string):
        for point in string.stones:
            ...
            self._hash ^= zobrist.HASH_COED[point, string.color]
    ...
    def __init__(self, board, next_player, previous, move):
        ...
        if self.previous_state is None:
            ...
            self.previous_states = frozenset(
                ...
                {(previous.next_player, previous.board.zobr_hash())})
        self.last_move = move
